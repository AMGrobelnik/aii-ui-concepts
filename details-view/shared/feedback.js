/* AI Inventor mockups — feedback widget (SPEC §4).
   Docks bottom-right on every mockup page, persists to localStorage, and
   exposes the reading API the index page uses. Styling lives in chrome.css. */
...
(function () {
  ...
  var ORDER = [
    'details/0-baseline', 'details/1-turns', 'details/2-chapters',
    'details/3-notebook', 'details/4-outline', 'details/5-timeline',
    'details/6-decisions', 'details/7-rows',
    'other/summary-a', 'other/summary-b',
    'other/progress-a', 'other/progress-b', 'other/runs-index'
  ];
